            ...
            steps {
				...
				script {
					docker.withTool('docker'){
						...
						sh "docker -H tcp://172.16.7.147:2375 login -u opradm -p $(oc whoami -t) docker-registry-default.dev.ipaas.frxs.com"
						sh "docker -H tcp://172.16.7.147:2375 tag gateway/api:latest docker-registry-default.dev.ipaas.frxs.com/gateway/api:latest"
						sh "docker -H tcp://172.16.7.147:2375 push docker-registry-default.dev.ipaas.frxs.com/gateway/api:latest"
					}
				}
            }
        }
