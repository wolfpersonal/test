            ...
            steps {
				...
				script {
					docker.withTool('docker'){
						...
						sh "docker -H tcp://172.16.7.147:2375 login -u opradm -p \$(oc whoami -t) docker-registry-default.dev.ipaas.frxs.com && docker -H tcp://172.16.7.147:2375 docker-registry-default.dev.ipaas.frxs.com/openshift/redhat-openjdk18-openshift"
					}
